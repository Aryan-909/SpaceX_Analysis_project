...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                dcc.Dropdown(id='site-dropdown',options = [
                                    ...
                                    [{'label':str(launch_sites[i]), 'value' : str(launch_sites[i])}
                                     for i in range(4)],                                    
...
def get_pie_chart(entered_site, payload_range):
    data = spacex_df
    l,h = payload_range
    mask = (spacex_df['Payload Mass (kg)'] >= int(l)) & (spacex_df['Payload Mass (kg)']<= int(h))
    if entered_site == 'ALL':
        ...
        new_data = spacex_df[spacex_df['Launch Site'] == entered_site]
        fig = px.scatter(new_data[mask], x = 'Payload Mass (kg)', y = 'class',
                         color = 'Booster Version Category')
